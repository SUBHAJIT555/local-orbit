...
const SingleItem = ({ item }: { item: Product }) => {
  ...
  return (
    <div className="group">
      <div className="relative overflow-hidden rounded-lg border border-gray-200 ring-1 ring-gray-200 ring-offset-2 min-h-[403px]">
        ...
        <div className="flex justify-center items-center">
          <Image src={item.img} alt={item.title} width={280} height={280} />
        </div>
        ...
        <div className="absolute right-0 bottom-0 translate-x-full u-w-full flex flex-col gap-2 p-5.5 ease-linear duration-300 group-hover:translate-x-0">
          ...
          <button
            ...
            id="addFavOne"
            className={`flex items-center justify-center w-9 h-9 rounded-[5px] shadow-1 ease-out duration-200 bg-white hover:opacity-90 ${isInWishlist ? "text-red" : "text-dark hover:text-white hover:bg-blue"
              }`}
          >
            <svg
              className="fill-current"
