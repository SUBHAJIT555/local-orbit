  ...
  return (
    ...
    >
      <div className="flex items-center justify-center ">
        <div className="w-full max-w-[1100px] rounded-xl shadow-3 bg-white p-7.5 relative modal-content border border-gray-200 ring-1 ring-gray-200 ring-offset-4 md:ring-offset-8"
        >
          <button
