...
const ProductItem = ({ item }: { item: Product }) => {
  ...
  return (
    <div className="group">
      <div className="relative overflow-hidden flex items-center justify-center rounded-lg border border-gray-200 ring-1 ring-gray-200 ring-offset-2 min-h-[270px] mb-4">
