...
const SingleGridItem = ({ item }: { item: Product }) => {
  ...
  return (
    <div className="group">
      <div className="relative overflow-hidden flex items-center justify-center rounded-lg border border-gray-200 ring-1 ring-gray-200 ring-offset-2 shadow-1 min-h-[270px] mb-4">
        ...
        <div className="absolute left-0 bottom-0 translate-y-full w-full flex items-center justify-center gap-2.5 pb-5 ease-linear duration-200 group-hover:translate-y-0">
          <button
            ...
            className="flex items-center justify-center w-9 h-9 rounded-full border border-gray-200 shadow-1 ease-out duration-200 text-dark bg-white hover:text-blue"
          >
            <svg
          ...
          <button
            ...
            id="favOne"
            className={`flex items-center justify-center w-9 h-9 rounded-full border border-gray-200 shadow-1 ease-out duration-200 bg-white hover:opacity-90 ${isInWishlist ? "text-red" : "text-dark hover:text-blue"
              }`}
          >
            <svg
              className="fill-current"
