          ...
          <div className="flex w-full lg:w-auto items-center gap-7.5">
            ...
            <div className="flex w-full lg:w-auto justify-between items-center gap-5">
              ...
              <button
                ...
                className="xl:hidden flex items-center justify-center w-10 h-10 rounded-md border border-gray-3 bg-gray-1 hover:bg-gray-2 text-dark"
                onClick={() => setNavigationOpen(!navigationOpen)}
              >
                <span className="block relative cursor-pointer w-5.5 h-5.5">
                  <span className="du-block absolute right-0 w-full h-full">
                    <span
                      className={`block relative top-0 left-0 rounded-sm w-0 h-0.5 my-1 ease-in-out duration-200 delay-[0] ${!navigationOpen ? "!w-full delay-300 bg-[var(--color-dark)]" : "bg-[var(--color-dark)]"
                        }`}
                    ></span>
                    <span
                      className={`block relative top-0 left-0 rounded-sm w-0 h-0.5 my-1 ease-in-out duration-200 delay-150 ${!navigationOpen ? "!w-full delay-400 bg-[var(--color-dark)]" : "bg-[var(--color-dark)]"
                        }`}
                    ></span>
                    <span
                      className={`block relative top-0 left-0 rounded-sm w-0 h-0.5 my-1 ease-in-out duration-200 delay-200 ${!navigationOpen ? "!w-full delay-500 bg-[var(--color-dark)]" : "bg-[var(--color-dark)]"
                        }`}
                    ></span>
                  </span>
                  ...
                  <span className="block absolute right-0 w-full h-full rotate-45">
                    <span
                      className={`block rounded-sm ease-in-out duration-200 delay-300 absolute left-2.5 top-0 w-0.5 h-full bg-[var(--color-dark)] ${!navigationOpen && "!h-0 delay-[0] "
                        }`}
                    ></span>
                    <span
                      className={`block rounded-sm ease-in-out duration-200 delay-400 absolute left-0 top-2.5 w-full h-0.5 bg-[var(--color-dark)] ${!navigationOpen && "!h-0 dealy-200"
                        }`}
                    ></span>
                  </span>
                </span>
