      ...
      <section className="overflow-hidden py-20">
        <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
          <div className="flex flex-col xl:flex-row gap-7.5">
            <div className="xl:max-w-[370px] w-full bg-white rounded-xl border border-gray-200 ring-1 ring-gray-200 ring-offset-4 md:ring-offset-8 shadow-1">
              ...
              <div className="p-4 sm:p-7.5">
                <div className="flex flex-col gap-4">
                  ...
                  <p className="flex gap-4">
                    ...
                    Address: {siteConfig.brand.address.full}
                  </p>
                </div>
              </div>
            </div>

            <div className="xl:max-w-[770px] w-full bg-white rounded-xl border border-gray-200 ring-1 ring-gray-200 ring-offset-4 md:ring-offset-8 shadow-1 p-4 sm:p-7.5 xl:p-10">
